...
export default function Page3Block() {
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center gap-4 sm:gap-6">
        {LINES.map((line) => (
          <div
            key={line}
            data-sc="idle"
            className="font-mono text-[clamp(1.5rem,7vw,5rem)] font-medium tracking-tighter text-center leading-tight"
          >
            {line}
          </div>
        ))}

        {/* terminals — stacked on mobile, row on md+ */}
        <div className="flex flex-col md:flex-row items-center w-full justify-center mt-2 sm:mt-4 gap-0">
          {/* left terminal — Claude Code */}
          <div className="w-full max-w-[280px] md:max-w-none md:w-[clamp(132px,22vw,380px)] bg-[#D97757] shrink-0">
            <div className="flex flex-col">
              <div className="w-full px-3 py-1.5 font-mono text-[clamp(10px,1.5vw,13px)] text-white/70 leading-none border-b border-white/20 flex items-center gap-1.5">
              ...
              <div className="p-2.5 sm:p-3">
                <div className="w-full gap-1 h-fit py-1.5 font-mono text-[clamp(11px,1.8vw,15px)] text-white/60 bg-white/20 leading-[1.3] flex items-center">
                  &gt; add retry handling
                </div>
                <div className="w-full mt-1 text-white/70 font-mono text-[clamp(11px,1.8vw,15px)] leading-[1.3] flex items-center gap-1">
                  <span className="text-white">✓</span> Checked Coord
                </div>
                <div className="w-full mt-1 text-white/70 font-mono text-[clamp(11px,1.8vw,15px)] leading-[1.3] flex items-start">
                ...
                <div className="w-full gap-1 mt-1 border-y border-white/30 py-1.5 text-white/70 flex items-center font-mono text-[clamp(11px,1.8vw,15px)] leading-[1.3]">
          ...
          <div className="w-0.5 h-4 md:h-0.5 md:w-5 bg-[#007a55] shrink-0" />

          {/* Coord hub */}
          <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#007a55] flex items-center justify-center shrink-0">
          ...
          <div className="w-full max-w-[280px] md:max-w-none md:w-[clamp(132px,22vw,380px)] bg-[#3941FF] shrink-0">
            <div className="flex flex-col">
              <div className="w-full px-3 py-1.5 font-mono text-[clamp(10px,1.5vw,13px)] text-white/70 leading-none border-b border-white/20 flex items-center gap-1.5">
                <svg height="1em" viewBox="0 0 24 24" width="1em" className="shrink-0">
              ...
              <div className="p-2.5 sm:p-3">
                ...
                <div className="w-full gap-1 mt-1 bg-white/20 py-1.5 text-white/70 flex items-center font-mono text-[clamp(11px,1.8vw,15px)] leading-[1.3]">
