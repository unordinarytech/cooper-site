...
export default function Home() {
  ...
  return (
    <>
      <Scene3D />
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 sm:pt-10 pb-4 pointer-events-none">
        <div className="flex items-center gap-2 sm:gap-3 font-mono text-sm sm:text-base font-bold tracking-tighter text-[#007a55]">
